...
function BookingRow({ userData, booking, setTargetBooking, targetBooking, bookings, setBookings, bookingStatus, setBookingStatus }: BookingRowProps) {
    ...
    return (
        <tr className="row_wrapper">
            {userData.role === "manager" && <td className="row_cell">{booking.user.name}</td>}
            {userData.role === "manager" && <td className="row_cell">{booking.user.email}</td>}
            {userData.role === "manager" && <td className="row_cell">{booking.user.mobile_number}</td>}
