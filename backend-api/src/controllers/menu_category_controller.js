...
const getAllMenuCategories = (req, res) => {
    try {
        // Call the listAllMenuCategories function from the resource file
        listAll(req, res);
    } catch (error) {
...
const getMenuCategoryById = (req, res) => {
    try {
        // Call the getMenuCategoryById function from the resource file
        getById(req, res);
    } catch (error) {
        // In the eventuality of an error occurring
        console.error(error);
...
const addMenuCategory = (req, res) => {
    try {
        // Call the addMenuCategory function from the resource file
        save(req, res);
    } catch (error) {
        // In the eventuality of an error occurring
        console.error(error);
...
const updateMenuCategory = (req, res) => {
    try {
        // Call the updateMenuCategory function from the resource file
        update(req, res);
    } catch (error) {
        console.error(error);
        res.status(500).json({ error: 'Internal Server Error' });
...
const deleteMenuCategory = (req, res) => {
    try {
        // Call the deleteMenuCategory function from the resource file
        destroy(req, res);
    } catch (error) {
        console.error(error);
        res.status(500).json({ error: 'Internal Server Error' });
